package com.c2.airseat.presentation.calendar
...
import com.c2.airseat.databinding.FragmentCalendarBottomSheetBinding
import com.c2.airseat.databinding.ItemSingleDayBinding
import com.c2.airseat.utils.calendar.ContinuousSelectionHelper.getSelection
import com.c2.airseat.utils.calendar.ContinuousSelectionHelper.isInDateBetweenSelection
import com.c2.airseat.utils.calendar.ContinuousSelectionHelper.isOutDateBetweenSelection
import com.c2.airseat.utils.calendar.DateSelection
import com.c2.airseat.utils.calendar.displayText
import com.c2.airseat.utils.calendar.getDrawableCompat
import com.c2.airseat.utils.calendar.makeInVisible
import com.c2.airseat.utils.calendar.makeVisible
import com.c2.airseat.utils.calendar.setTextColorRes
import com.c2.airseat.utils.toFormattedCompleteDateNumber
...
class CalendarHistoryBottomSheetFragment : BottomSheetDialogFragment() {
    ...
    override fun onViewCreated(
        ...
        binding.btnSaveDate.setOnClickListener {
            ...
            val result =
                Bundle().apply {
                    if (startDate != null && endDate != null) {
                        putString("startDate", startDate.toFormattedCompleteDateNumber())
                        putString("endDate", endDate.toFormattedCompleteDateNumber())
                    }
                }
            parentFragmentManager.setFragmentResult("rangeDate", result)
            dismiss()
        }
        ...
        binding.tvStartDate.apply {
            text =
                if (selection.startDate != null) {
                    headerDateFormatter.format(selection.startDate)
                } else {
        ...
        binding.tvEndDate.apply {
            text =
                if (selection.endDate != null) {
                    headerDateFormatter.format(selection.endDate)
                } else {
            ...
            init {
                view.setOnClickListener {
                    if (day.position == DayPosition.MonthDate) {
                        ...
                        this@CalendarHistoryBottomSheetFragment.binding.calendarView.notifyCalendarChanged()
                        bindSummaryViews()
                    }
                }
            }
