package com.nafi.airseat.utils.seatbookreturn
...
class SeatBookReturnView
    ...
    LinearLayout(context, attrs) {
        ...
        fun isCustomTitle(r: Boolean): SeatBookReturnView {
            isCustomTitle = r
            return this
        }

        fun setCustomTitle(titles: List<String>): SeatBookReturnView {
            title = titles
            return this
        }

        fun setSelectSeatLimit(limit: Int): SeatBookReturnView {
        ...
        fun setSeatGaping(size: Int): SeatBookReturnView {
            seatGaping = (size / density).toInt()
            return this
        }

        fun setSeatLayoutPadding(size: Int): SeatBookReturnView {
            layout_padding = (size / density).toInt()
            return this
        }

        fun setSeatSize(size: Int): SeatBookReturnView {
        ...
        fun setSeatsLayoutString(seats: String): SeatBookReturnView {
            this.seats = seats
            return this
        }
        ...
        fun setAvailableSeatsBackground(drawable: Int): SeatBookReturnView {
        ...
        fun setBookedSeatsBackground(drawable: Int): SeatBookReturnView {
            bookedDrawable = drawable
            return this
        }

        fun setReservedSeatsBackground(drawable: Int): SeatBookReturnView {
            reservedDrawable = drawable
            return this
        }

        fun setSelectedSeatsBackground(drawable: Int): SeatBookReturnView {
        ...
        fun setReservedSeatsTextColor(color: Int): SeatBookReturnView {
            reservedTextColor = color
            return this
        }

        fun setAvailableSeatsTextColor(color: Int): SeatBookReturnView {
            bookTextColor = color
            return this
        }

        fun setBookedSeatsTextColor(color: Int): SeatBookReturnView {
